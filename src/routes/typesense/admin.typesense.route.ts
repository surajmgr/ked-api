...
const collectionsSchema = z.enum(["content", "questions", "no_hit_queries", "popular_queries"]);
const rulesSchema = z.enum(["no_hit_queries_aggregation", "popular_queries_aggregation", "content_events_aggregation", "question_events_aggregation"]);
