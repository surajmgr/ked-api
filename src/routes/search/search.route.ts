...
import { generalQuestionParamsSchema, generalQuestionSearchResultSchema } from '@/lib/typesense/schema/question.schema';
import { generalContentParamsSchema, generalContentSearchResultSchema } from '@/lib/typesense/schema/content.schema';
import {
  generalSuggestionParamsSchema,
  generalSuggestionSearchResultSchema,
} from '@/lib/typesense/schema/analytics.schema';
