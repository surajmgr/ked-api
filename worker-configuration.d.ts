/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 0b194eeec74b4eceae7b7bfd0ef3cefb)
...
declare namespace Cloudflare {
	...
	interface Env {
		KED_KV: KVNamespace;
		AUTH_API_URL: "https://cf-auth.surajpulami.com.np";
		TRUSTED_ORIGINS: "*.surajpulami.com.np";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_API_URL" | "TRUSTED_ORIGINS">> {}
}
